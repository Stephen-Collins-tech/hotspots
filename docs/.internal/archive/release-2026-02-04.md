# Release Instructions for Hotspots 0.0.1
...
- [ ] GitHub repository exists: https://github.com/Stephen-Collins-tech/hotspots
...
**Expected output:**
```
To github.com:Stephen-Collins-tech/hotspots.git
...
1. Visit: https://github.com/Stephen-Collins-tech/hotspots
2. Check that files are visible (README, LICENSE-MIT, etc.)
3. Check that tag appears: https://github.com/Stephen-Collins-tech/hotspots/tags

---

## Step 2: Create GitHub Release (Optional but Recommended)

1. Go to: https://github.com/Stephen-Collins-tech/hotspots/releases/new
2. Select tag: `v0.0.1`
...
3. Click "New Token"
4. Name it (e.g., "hotspots-publish")
5. Copy the token
...
**Expected output:**
```
   Packaging hotspots-core v0.0.1
   Verifying hotspots-core v0.0.1
   Compiling hotspots-core v0.0.1
    Finished dev [unoptimized + debuginfo] target(s)
   Uploading hotspots-core v0.0.1
```
...
**Expected output:**
```
   Packaging hotspots-cli v0.0.1
   Verifying hotspots-cli v0.0.1
   Compiling hotspots-cli v0.0.1
    Finished dev [unoptimized + debuginfo] target(s)
   Uploading hotspots-cli v0.0.1
```

### 3.6 Verify on crates.io

1. Core: https://crates.io/crates/hotspots-core
2. CLI: https://crates.io/crates/hotspots-cli
...
- Rename the crates (e.g., `hotspots-ts`, `hotspots-analyzer`)
...
**Solution:** Wait longer after publishing `hotspots-core`. It can take 1-2 minutes to be available.
...
- [ ] Test `cargo install hotspots-cli` works
...
- [ ] Add shield badges to README (optional):
  ```markdown
  [![Crates.io](https://img.shields.io/crates/v/hotspots-cli.svg)](https://crates.io/crates/hotspots-cli)
