...
### Bug Fixes
- Bump publish-npm to Node 24 for npm@latest compat (#198)

## [1.39.0] - 2026-09-18

### Features
- Coordinate knowledge_mode + --diff/--staged input modes (#195)
...
### Features
- Add hotspots estimate pre-flight runtime projection
...
### Bug Fixes
- Bound Rust CFG builder recursion depth (#161)

## [1.35.4] - 2026-08-30

### Bug Fixes
- Gate burst_score git log walk behind skip-touch-metrics (#158)
...
- Model each Python match case as its own CFG branch (#154)
- Walk Go statement_list bodies and route break/continue (#155)
...
### Features
- Add hotspots upgrade command (#134)

## [1.34.1] - 2026-08-19

### Bug Fixes
- Bound C parser with a timeout to avoid GLR hangs (#129)
- Cap directed coupling git log walk at 2 years (#131)
...
### Bug Fixes
- Remove burst_score from live activity-risk score (#126)

## [1.33.1] - 2026-07-19

### Performance
- Fold burst_score into history_signals shared git-log walk (#125)

## [1.33.0] - 2026-07-15

### Features
- F62/F63 Gini-gated cold-start routing

## [1.32.0] - 2026-07-15

### Features
- F63 cold-start history signals prerequisite

## [1.31.0] - 2026-07-14

### Features
- F93 burst-score term in activity-risk formula (#120)
...
### Features
- F61 regime-based model class auto-selection (Q3 screener) (#114)
...
[1.38.0]: https://github.com/Stephen-Collins-tech/hotspots/releases/tag/v1.38.0
[1.37.0]: https://github.com/Stephen-Collins-tech/hotspots/releases/tag/v1.37.0
[1.36.0]: https://github.com/Stephen-Collins-tech/hotspots/releases/tag/v1.36.0
[1.35.5]: https://github.com/Stephen-Collins-tech/hotspots/releases/tag/v1.35.5
[1.35.4]: https://github.com/Stephen-Collins-tech/hotspots/releases/tag/v1.35.4
[1.35.3]: https://github.com/Stephen-Collins-tech/hotspots/releases/tag/v1.35.3
[1.35.2]: https://github.com/Stephen-Collins-tech/hotspots/releases/tag/v1.35.2
...
[1.32.0]: https://github.com/Stephen-Collins-tech/hotspots/releases/tag/v1.32.0
[1.31.0]: https://github.com/Stephen-Collins-tech/hotspots/releases/tag/v1.31.0
