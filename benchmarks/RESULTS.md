...
| git/git | C | +0.379 | 0.50 | 633 | 244 |
| redis/redis | C | +0.525 | 0.80 | 162 | 46 |
| curl/curl | C | +0.426 | 1.00 | 632 | 216 |
| microsoft/vscode | TypeScript | +0.310 | 0.30 | 2,245 | 642 |
...
|---|---|---|---|---|---|
| [v1.30.0](versions/v1.30.0.json) | 2026-07-12 | +0.387 | 0.54 | off | +`burst_score` (F93 commit-timing burstiness term) |
